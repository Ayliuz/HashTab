...
const int GUARD = 32234;
const int GUARDPOIS = -1;
const int SIZEPOIS = -1;
const int HASHPOIS = -1;
const int HASHDEFAULT = 0;
const int ERROROK = 0;
const int ERRORDATA = 1;
const int ERRORCAPACITY = 2;
const int ERRORSIZE = 3;
const int ERRORPOP = 4;
const int ERRORMEMORY = 5;
const int ERRORSTRUCT = 6;
